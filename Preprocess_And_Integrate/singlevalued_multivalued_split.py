...
if __name__ == '__main__':
    with open('../data/merged/merged_anime_data_with_title_as_key.json', 'r') as f:
    ...
    with open('../data/split/single_valued_list.json', 'w') as f:
        json.dump(single_valued, f, indent=3)
    with open('../data/split/multi_valued_list.json', 'w') as f:
        json.dump(multi_valued, f, indent=3)
    with open('../data/split/single_valued_dict.json', 'w') as f:
        json.dump(single_valued_dict, f, indent=3)
    with open('../data/split/multi_valued_dict.json', 'w') as f:
